...
extension ShortcutAction {
    ...
    public var defaultStroke: ShortcutStroke? {
        ...
        case .hideSidebar: return ShortcutStroke(key: "[", command: true)
        case .showSidebar: return ShortcutStroke(key: "]", command: true)
        ...
        case .focusHistoryBack: return ShortcutStroke(key: "[", command: true, option: true)
        case .focusHistoryForward: return ShortcutStroke(key: "]", command: true, option: true)
