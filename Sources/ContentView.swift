...
struct ContentView: View {
    ...
    private func terminalContentWithRightSidebarPanel(appearance: WindowAppearanceSnapshot) -> some View {
        ...
        // The file explorer is likewise always in the view tree; visibility is
        // controlled by frame width (0 when hidden) to avoid transition
        // animations. The bottom status bar is stacked below the terminal row.
    ...
    private func syncLeftFileExplorerDirectory() {
        ...
        leftFileExplorerStore.applyWorkspaceRoot(.local(workspaceId: tab.id, path: dir))
    }
...
struct TabItemView: View, Equatable {
    ...
    @ViewBuilder
    private func detailedRowContent(
        ...
        scaledCloseButtonWidth: CGFloat,
        scaledCloseButtonHitSize: CGFloat
    ) -> some View {
        let audioPlayingTooltip = String(
            localized: "sidebar.mediaActivity.audio.tooltip",
            defaultValue: "Playing audio"
    ...
    @ViewBuilder
    private func sidebarRowAppearance(
        workspaceSnapshot: SidebarWorkspaceSnapshotBuilder.Snapshot,
        protectedWorkspaceTooltip: String,
        closeButtonTooltip: String,
        effectiveSubtitle: String?,
        ...
        if settings.compactRowMode {
            ...
            detailedRowContent(
                ...
                scaledCloseButtonWidth: scaledCloseButtonWidth,
                scaledCloseButtonHitSize: scaledCloseButtonHitSize
            )
        }
        }
