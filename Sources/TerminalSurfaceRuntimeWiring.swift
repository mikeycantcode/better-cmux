...
final class TerminalSurfaceSpawnPolicyBridge: TerminalSurfaceSpawnPolicyProviding {
    func currentSpawnPolicy() -> TerminalSurfaceSpawnPolicy {
        ...
        return TerminalSurfaceSpawnPolicy(
            ...
            agentCapabilityBriefEnvironmentKey: AgentCapabilityBriefSettings.isEnabled() ? AgentCapabilityBriefSettings.environmentKey : nil,
            agentCapabilityBriefText: AgentCapabilityBriefSettings.isEnabled() ? AgentCapabilityBrief.text : nil
        )
    }
